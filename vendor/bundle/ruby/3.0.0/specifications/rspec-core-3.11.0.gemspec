# -*- encoding: utf-8 -*-
# stub: rspec-core 3.11.0 ruby lib
...
Gem::Specification.new do |s|
  ...
  s.summary = "rspec-core-3.11.0".freeze
  ...
  if s.respond_to? :add_runtime_dependency then
    s.add_runtime_dependency(%q<rspec-support>.freeze, ["~> 3.11.0"])
    ...
    s.add_dependency(%q<rspec-support>.freeze, ["~> 3.11.0"])
